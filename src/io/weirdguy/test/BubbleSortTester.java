...
import io.weirdguy.practice.sorters.BubbleSort;
 ...
 */
public class BubbleSortTester extends SortStrategyUnitTester{

    @BeforeClass
    public static void setSortStrategy(){
        mySorter.setCurrentSortStrategy(new BubbleSort());
    }
